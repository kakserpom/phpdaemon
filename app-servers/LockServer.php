 ...
 */
 public function done($name,$result)
 {
  if (isset($this->appInstance->lockState[$name]) && ($this->appInstance->lockState[$name] === 1)
   && isset($this->appInstance->lockConnState[$name][$this->connId]) && ($this->appInstance->lockConnState[$name][$this->connId] === 1))
  {
 ...
 */
 public function onFinish()
 {
  ...
  foreach ($this->locks as $name => $status)
  {
   ...
   elseif ($status === 2) {unset($this->appInstance->lockConnState[$name][$this->connId]);}
  }
